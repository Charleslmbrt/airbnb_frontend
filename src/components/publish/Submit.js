  ...
  return (
    <>
      <div className="mx-10 sm:flex sm:flex-col sm:items-center">
        ...
        <p className="text-xl text-gray-400 font-light my-2">
          Here's what we'll show to guests. Make sure everything looks good.
        </p>
        <div className=" bg-white drop-shadow-lg rounded-xl p-4 mt-5">
          <ModalPreview
            address={address}
            guests={guests}
            beds={beds}
        ...
        <div className="flex flex-col mb-[50px]">
          <button
            className="mt-10 mb-20 w-full rounded-xl p-5 bg-red-400 text-white"
